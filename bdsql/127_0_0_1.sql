...
--
-- Host: 127.0.0.1
-- Tempo de geração: 25-Jul-2020 às 01:09
...
--
-- Banco de dados: `atena_bd`
--
CREATE DATABASE IF NOT EXISTS `atena_bd` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `atena_bd`;
...
CREATE TABLE `user` (
  ...
  `nameAddress` varchar(45) DEFAULT NULL,
  `cep` varchar(10) DEFAULT NULL,
  `numberAd` varchar(20) DEFAULT NULL,
  `neighborhood` varchar(100) DEFAULT NULL,
  `city` varchar(100) DEFAULT NULL,
  `reference` varchar(100) DEFAULT NULL,
  `complement` varchar(100) DEFAULT NULL,
  `stateAnd` varchar(100) DEFAULT NULL,
...
--
ALTER TABLE `address`
  ADD PRIMARY KEY (`idAddress`,`userID`),
...
('root', '[{\"db\":\"atena_bd\",\"table\":\"user\"},{\"db\":\"atena_bd\",\"table\":\"address\"},{\"db\":\"atena_bd\",\"table\":\"gender\"}]');
...
('root', '2020-07-24 22:45:50', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"pt\"}');
